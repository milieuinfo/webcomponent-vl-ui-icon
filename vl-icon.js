import{VlElement}from"https://cdn.milieuinfo.be/vl-ui-core/1.1.0/vl-core.js";export class VlIcon extends VlElement(HTMLElement){static get _observedAttributes(){return["icon","size"]}static get _observedChildClassAttributes(){return["before","after"]}constructor(){super(`
            <style>
